...
var file_datanode_proto_rawDesc = []byte{
	...
	0xb1, 0x02, 0x0a, 0x0f, 0x44, 0x61, 0x74, 0x61, 0x4e, 0x6f, 0x64, 0x65, 0x48, 0x61, 0x6e, 0x64,
	...
	,
...
var file_datanode_proto_depIdxs = []int32{
	...
	4, // 4: datanode.DataNodeHandler.DistUploadFile:input_type -> datanode.chunk
	6, // 5: datanode.DataNodeHandler.DownloadFile:input_type -> datanode.fileInfo
	1, // 6: datanode.DataNodeHandler.Ping:input_type -> datanode.ping
	3, // 7: datanode.DataNodeHandler.UploadBook:output_type -> datanode.response
	3, // 8: datanode.DataNodeHandler.UploadFile:output_type -> datanode.response
	3, // 9: datanode.DataNodeHandler.DistUploadFile:output_type -> datanode.response
	5, // 10: datanode.DataNodeHandler.DownloadFile:output_type -> datanode.chunkResponse
	1, // 11: datanode.DataNodeHandler.Ping:output_type -> datanode.ping
...
type DataNodeHandlerClient interface {
	...
	DistUploadFile(ctx context.Context, opts ...grpc.CallOption) (DataNodeHandler_DistUploadFileClient, error)
...
func (c *dataNodeHandlerClient) DistUploadFile(ctx context.Context, opts ...grpc.CallOption) (DataNodeHandler_DistUploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DataNodeHandler_serviceDesc.Streams[2], "/datanode.DataNodeHandler/DistUploadFile", opts...)
	if err != nil {
		return nil, err
	}
	x := &dataNodeHandlerDistUploadFileClient{stream}
	return x, nil
}

type DataNodeHandler_DistUploadFileClient interface {
	Send(*Chunk) error
	Recv() (*Response, error)
	grpc.ClientStream
}

type dataNodeHandlerDistUploadFileClient struct {
	grpc.ClientStream
}

func (x *dataNodeHandlerDistUploadFileClient) Send(m *Chunk) error {
	return x.ClientStream.SendMsg(m)
}

func (x *dataNodeHandlerDistUploadFileClient) Recv() (*Response, error) {
	m := new(Response)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *dataNodeHandlerClient) DownloadFile(ctx context.Context, opts ...grpc.CallOption) (DataNodeHandler_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DataNodeHandler_serviceDesc.Streams[3], "/datanode.DataNodeHandler/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *dataNodeHandlerClient) Ping(ctx context.Context, opts ...grpc.CallOption) (DataNodeHandler_PingClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DataNodeHandler_serviceDesc.Streams[4], "/datanode.DataNodeHandler/Ping", opts...)
	if err != nil {
		return nil, err
	}
...
type DataNodeHandlerServer interface {
	...
	DistUploadFile(DataNodeHandler_DistUploadFileServer) error
...
func (*UnimplementedDataNodeHandlerServer) DistUploadFile(DataNodeHandler_DistUploadFileServer) error {
	return status.Errorf(codes.Unimplemented, "method DistUploadFile not implemented")
}
...
func _DataNodeHandler_DistUploadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DataNodeHandlerServer).DistUploadFile(&dataNodeHandlerDistUploadFileServer{stream})
}

type DataNodeHandler_DistUploadFileServer interface {
	Send(*Response) error
	Recv() (*Chunk, error)
	grpc.ServerStream
}

type dataNodeHandlerDistUploadFileServer struct {
	grpc.ServerStream
}

func (x *dataNodeHandlerDistUploadFileServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *dataNodeHandlerDistUploadFileServer) Recv() (*Chunk, error) {
	m := new(Chunk)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _DataNodeHandler_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "DistUploadFile",
			Handler:       _DataNodeHandler_DistUploadFile_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
